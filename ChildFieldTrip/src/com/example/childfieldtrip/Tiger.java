	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tiger);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "tigerimage.jpg");
		    String path = stuff + "/tigerimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "tigerimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldtigerimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldtigerimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldtigerimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldtigerimage.jpg";
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.tiger);
		            currentImage = 0;
		            }
		            }
	@Override
