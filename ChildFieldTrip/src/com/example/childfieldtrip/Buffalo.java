...
public class Buffalo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_buffalo);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "buffaloimage.jpg");
		    String path = stuff + "/buffaloimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "buffaloimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldbuffaloimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldbuffaloimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldbuffaloimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldbuffaloimage.jpg";
		    	    ...
		    	    File file = new File (thing, "buffaloimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/buffaloimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.buffalo);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.buffalo);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.buffalo);
		            currentImage = 0;
		            }
		            }
	@Override
