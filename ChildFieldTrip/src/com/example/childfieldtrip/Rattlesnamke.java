...
public class Rattlesnamke extends Activity {
	private int currentImage = 0;
	private int numImages = 3;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_rattlesnamke);
		 File stuff = Environment.getExternalStorageDirectory();
		    
		    File thing = new File (stuff.getAbsolutePath());
		    File file = new File (thing, "rattlesnamkeimage.jpg");
		    String path = stuff + "/rattlesnamkeimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "rattlesnamkeimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldrattlesnamkeimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldrattlesnamkeimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldrattlesnamkeimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldrattlesnamkeimage.jpg";
		    	    ...
		    	    File file = new File (thing, "rattlesnamkeimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/rattlesnamkeimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.rattlesnake);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.rattlesnake);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.rattlesnake);
		            currentImage = 0;
		            }
		            }
	@Override
