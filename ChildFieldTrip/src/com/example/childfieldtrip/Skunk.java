...
public class Skunk extends Activity {
	private int currentImage = 0;
	private int numImages = 5;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_skunk);
		 File stuff = Environment.getExternalStorageDirectory();
		    
		    File thing = new File (stuff.getAbsolutePath());
		    File file = new File (thing, "skunkimage.jpg");
		    String path = stuff + "/skunkimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "skunkimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldskunkimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldskunkimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldskunkimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldskunkimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.skunk);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.skunk2);
                 break;
		            case 2:  imageI.setImageResource(R.drawable.skunk3);
                 break;
		            case 3: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.skunk);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.skunk);
		            currentImage = 0;
		            }
		            }
	@Override
