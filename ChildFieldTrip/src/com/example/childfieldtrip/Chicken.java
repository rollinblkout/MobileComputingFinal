	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chicken);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "chickenimage.jpg");
		    String path = stuff + "/chickenimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "chickenimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldchickenimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldchickenimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldchickenimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldchickenimage.jpg";
		    	    ...
		    	    File file = new File (thing, "chickenimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/chickenimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.chicken);
		            currentImage = 0;
		            }
		            }
	@Override
