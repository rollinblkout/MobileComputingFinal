	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_parrot);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "parrotimage.jpg");
		    String path = stuff + "/parrotimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "parrotimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldparrotimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldparrotimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldparrotimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldparrotimage.jpg";
		    	    ...
		    	    File file = new File (thing, "parrotimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/parrotimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.parrot);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.parrot);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.parrot);
		            currentImage = 0;
		            }
		            }
	@Override
