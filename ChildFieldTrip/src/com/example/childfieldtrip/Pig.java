	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pig);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "pigimage.jpg");
		    String path = stuff + "/pigimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "pigimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldpigimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldpigimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldpigimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldpigimage.jpg";
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.pig);
		            currentImage = 0;
		            }
		            }
	@Override
