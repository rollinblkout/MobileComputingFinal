	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_coyote);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "coyoteimage.jpg");
		    String path = stuff + "/coyoteimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "coyoteimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldcoyoteimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldcoyoteimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldcoyoteimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldcoyoteimage.jpg";
		    	    ...
		    	    File file = new File (thing, "coyoteimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/coyoteimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.coyote);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.coyote);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.coyote);
		            currentImage = 0;
		            }
		            }
	@Override
