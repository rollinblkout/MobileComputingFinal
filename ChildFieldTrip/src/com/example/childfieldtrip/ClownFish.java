...
public class ClownFish extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clown_fish);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "clownfishimage.jpg");
		    String path = stuff + "/clownfishimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "clownfishimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldclownfishimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldclownfishimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldclownfishimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldclownfishimage.jpg";
		    	    ...
		    	    File file = new File (thing, "clownfishimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/clownfishimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.clownfish);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.clownfish);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.clownfish);
		            currentImage = 0;
		            }
		            }
	@Override
