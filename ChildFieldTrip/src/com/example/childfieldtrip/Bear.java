...
public class Bear extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bear);
			  ...
			  File stuff = Environment.getExternalStorageDirectory();
			    ...
			    File file = new File (thing, "bearimage.jpg");
			    String path = stuff + "/bearimage.jpg";
			    if (file.exists())
			    {
			        ...
			        {
			        	File directory = new File(Environment.getExternalStorageDirectory(), "bearimage.jpg");
			        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldbearimage.jpg");
			        	if(directory.exists()){
			        		if (directory2.exists()) {
			        			directory2.delete();
			        			File blah = new File(Environment.getExternalStorageDirectory(), "oldbearimage.jpg");
		    	    ...
		    	    File file2 = new File (thing2, "oldbearimage.jpg");
		    	    if (file2.exists())
		    	    {

		      	          String p2 = thing2 + "/oldbearimage.jpg";
			            ...
			            switch (currentImage) {
			            case 0:  imageI.setImageResource(R.drawable.bear);
			                     break;
			            case 1:  imageI.setImageResource(R.drawable.bear2);
	                     break;
			            case 2: if (file.exists())
		            	{ imageI.setImageBitmap(initial); }
			            else { imageI.setImageResource(R.drawable.bear);
			            currentImage = 0;
			            }
		 	            break;
			            ...
			            currentImage = 0;
		 	            ...
		 	            break;
			            default: imageI.setImageResource(R.drawable.bear);
			            currentImage = 0;
			            }
			            }
		@Override
