	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wolf);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "wolfimage.jpg");
		    String path = stuff + "/wolfimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "wolfimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldwolfimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldwolfimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldwolfimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldwolfimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.wolf);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.wolf2);
                    break;
		            case 2:  imageI.setImageResource(R.drawable.wolf3);
                    break;
		            case 3: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.wolf);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.wolf);
		            currentImage = 0;
		            }
		            }
	@Override
