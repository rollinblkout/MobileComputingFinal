	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fox);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "foximage.jpg");
		    String path = stuff + "/foximage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "foximage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldfoximage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldfoximage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldfoximage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldfoximage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.fox);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.fox2);
                    break;
		            case 2: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.fox);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.fox);
		            currentImage = 0;
		            }
		            }
	@Override
