	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chameleon);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "chameleonimage.jpg");
		    String path = stuff + "/chameleonimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "chameleonimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldchameleonimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldchameleonimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldchameleonimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldchameleonimage.jpg";
		    	    ...
		    	    File file = new File (thing, "chameleonimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/chameleonimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.chameleon);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.chameleon);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.chameleon);
		            currentImage = 0;
		            }
		            }
	@Override
