	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hippo);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "hippoimage.jpg");
		    String path = stuff + "/hippoimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "hippoimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldhippoimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldhippoimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldhippoimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldhippoimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.hippo);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.hippo);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.hippo);
		            currentImage = 0;
		            }
		            }
	@Override
