...
public class Guineapig extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_guineapig);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "guineapigimage.jpg");
		    String path = stuff + "/guineapigimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "guineapigimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldguineapigimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldguineapigimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldguineapigimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldguineapigimage.jpg";
		    	    ...
		    	    File file = new File (thing, "guineapigimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/guineapigimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.guineapig);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.guineapig2);
                    break;
		            case 2:  imageI.setImageResource(R.drawable.guineapig3);
                    break;
		            case 3: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.guineapig);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.guineapig);
		            currentImage = 0;
		            }
		            }
	@Override
