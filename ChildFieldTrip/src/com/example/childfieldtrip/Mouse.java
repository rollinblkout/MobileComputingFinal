	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mouse);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "mouseimage.jpg");
		    String path = stuff + "/mouseimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "mouseimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldmouseimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldmouseimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldmouseimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldmouseimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.mouse);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.mouse);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.mouse);
		            currentImage = 0;
		            }
		            }
	@Override
