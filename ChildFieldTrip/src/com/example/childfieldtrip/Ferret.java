...
public class Ferret extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ferret);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "ferretimage.jpg");
		    String path = stuff + "/ferretimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "ferretimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldferretimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldferretimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldferretimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldferretimage.jpg";
		    	    ...
		    	    File file = new File (thing, "ferretimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/ferretimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.ferret);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.ferret2);
                    break;
		            case 2: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.ferret);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.ferret);
		            currentImage = 0;
		            }
		            }
	@Override
