	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_boar);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "boarimage.jpg");
		    String path = stuff + "/boarimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "boarimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldboarimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldboarimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldboarimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldboarimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.boar);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.boar);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.boar);
		            currentImage = 0;
		            }
		            }
	@Override
