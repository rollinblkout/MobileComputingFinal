...
public class Goldfish extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_goldfish);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "goldfishimage.jpg");
		    String path = stuff + "/goldfishimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "goldfishimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldgoldfishimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldgoldfishimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldgoldfishimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldgoldfishimage.jpg";
		    	    ...
		    	    File file = new File (thing, "goldfishimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/goldfishimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.goldfish);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.goldfish2);
                    break;
		            case 2:  imageI.setImageResource(R.drawable.goldfish3);
                    break;
		            case 3: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.goldfish);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.goldfish);
		            currentImage = 0;
		            }
		            }
	@Override
