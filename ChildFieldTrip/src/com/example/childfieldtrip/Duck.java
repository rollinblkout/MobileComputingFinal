	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_duck);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "duckimage.jpg");
		    String path = stuff + "/duckimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "duckimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldduckimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldduckimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldduckimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldduckimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.duck);
		                     break;
		            case 1:  imageI.setImageResource(R.drawable.duck2);
                    break;
		            case 2:  imageI.setImageResource(R.drawable.duck3);
                    break;
		            case 3: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.duck);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.duck);
		            currentImage = 0;
		            }
		            }
	@Override
