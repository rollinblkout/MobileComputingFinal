	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_corn_snake);
		  File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "cornsnakeimage.jpg");
		    String path = stuff + "/cornsnakeimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "cornsnakeimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldcornsnakeimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldcornsnakeimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldcornsnakeimage.jpg");
	    	    if (file2.exists())
	    	    {
	
	      	          String p2 = thing2 + "/oldcornsnakeimage.jpg";
		    	    ...
		    	    File file = new File (thing, "cornsnakeimage.jpg");
		        	  if (file.exists())
		      	    {
		        		  Date lastModDate = new Date(file.lastModified());  
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/cornsnakeimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.cornsnake);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.cornsnake);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.cornsnake);
		            currentImage = 0;
		            }
		            }
	@Override
