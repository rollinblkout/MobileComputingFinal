	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_crab);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "crabimage.jpg");
		    String path = stuff + "/crabimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "crabimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldcrabimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldcrabimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldcrabimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldcrabimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.crab);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.crab);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.crab);
		            currentImage = 0;
		            }
		            }
	@Override
