	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gorilla);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "gorillaimage.jpg");
		    String path = stuff + "/gorillaimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "gorillaimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldgorillaimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldgorillaimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldgorillaimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldgorillaimage.jpg";
		    	    ...
		    	    File file = new File (thing, "gorillaimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/gorillaimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.gorilla);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.gorilla);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.gorilla);
		            currentImage = 0;
		            }
		            }
	@Override
