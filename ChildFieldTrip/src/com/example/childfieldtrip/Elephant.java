	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_elephant);
		  File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "elephantimage.jpg");
		    String path = stuff + "/elephantimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "elephantimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldelephantimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldelephantimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldelephantimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	
	      	          String p2 = thing2 + "/oldelephantimage.jpg";
		    	    ...
		    	    File file = new File (thing, "elephantimage.jpg");
		        	  if (file.exists())
		      	    {
		        		  Date lastModDate = new Date(file.lastModified());  
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/elephantimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.elephant);
		            currentImage = 0;
		            }
		            }
	@Override
