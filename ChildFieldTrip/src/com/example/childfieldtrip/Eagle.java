...
public class Eagle extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_eagle);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "eagleimage.jpg");
		    String path = stuff + "/eagleimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "eagleimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldeagleimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldeagleimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldeagleimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldeagleimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.eagle);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.eagle);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.eagle);
		            currentImage = 0;
		            }
		            }
	@Override
