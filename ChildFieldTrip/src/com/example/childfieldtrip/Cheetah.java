	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cheetah);
		  File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "cheetahimage.jpg");
		    String path = stuff + "/cheetahimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "cheetahimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldcheetahimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldcheetahimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldcheetahimage.jpg");
	    	    if (file2.exists())
	    	    {

	      	          String p2 = thing2 + "/oldcheetahimage.jpg";
		    	    ...
		    	    File file = new File (thing, "cheetahimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/cheetahimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.cheetah);
		            currentImage = 0;
		            }
		            }
	@Override
