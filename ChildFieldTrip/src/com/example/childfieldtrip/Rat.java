	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_rat);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "ratimage.jpg");
		    String path = stuff + "/ratimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "ratimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldratimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldratimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldratimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldratimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.rat);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.rat);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.rat);
		            currentImage = 0;
		            }
		            }
	@Override
