	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_whale);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "whaleimage.jpg");
		    String path = stuff + "/whaleimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "whaleimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldwhaleimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldwhaleimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldwhaleimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldwhaleimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.whale);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.whale);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.whale);
		            currentImage = 0;
		            }
		            }
	@Override
