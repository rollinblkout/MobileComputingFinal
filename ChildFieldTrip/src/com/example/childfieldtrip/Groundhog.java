		...
		setContentView(R.layout.activity_groundhog);
		  File stuff = Environment.getExternalStorageDirectory();
		    ...
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "groundhogimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldgroundhogimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldgroundhogimage.jpg");
	    	    ...
	    	    if (file2.exists())
	    	    {
		    	    ...
		    	    File file = new File (thing, "groundhogimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/groundhogimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.groundhog);
		            currentImage = 0;
		            }
		            }
	@Override
