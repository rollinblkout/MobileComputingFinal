	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_toad);
		  File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "toadimage.jpg");
		    String path = stuff + "/toadimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "toadimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldtoadimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldtoadimage.jpg");
		            ...
		            {
		            	Intent e = new Intent(getApplicationContext(),Toad.class);
	    	    ...
	    	    File file2 = new File (thing2, "oldtoadimage.jpg");
	    	    if (file2.exists())
	    	    {

	      	
	      	          String p2 = thing2 + "/oldtoadimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.toad);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.toad);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.toad);
		            currentImage = 0;
		            }
		            }
	@Override
