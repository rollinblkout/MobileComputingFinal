...
public class Hyena extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "hyenaimage.jpg");
		    String path = stuff + "/hyenaimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "hyenaimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldhyenaimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldhyenaimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldhyenaimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldhyenaimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.hyena);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.hyena);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.hyena);
		            currentImage = 0;
		            }
		            }
	@Override
