	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shark);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "sharkimage.jpg");
		    String path = stuff + "/sharkimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "sharkimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldsharkimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldsharkimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldsharkimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldsharkimage.jpg";
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.shark);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.shark);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.shark);
		            currentImage = 0;
		            }
		            }
	@Override
