	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lobster);
		 File stuff = Environment.getExternalStorageDirectory();
		    ...
		    File file = new File (thing, "lobsterimage.jpg");
		    String path = stuff + "/lobsterimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "lobsterimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldlobsterimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldlobsterimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldlobsterimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldlobsterimage.jpg";
		    	    ...
		    	    File file = new File (thing, "lobsterimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/lobsterimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.lobster);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.lobster);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.lobster);
		            currentImage = 0;
		            }
		            }
	@Override
