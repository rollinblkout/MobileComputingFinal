...
public class Meerkat extends Activity {
	private int currentImage = 0;
	private int numImages = 3;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_meerkat);
		 File stuff = Environment.getExternalStorageDirectory();
		    
		    File thing = new File (stuff.getAbsolutePath());
		    File file = new File (thing, "meerkatimage.jpg");
		    String path = stuff + "/meerkatimage.jpg";
		    if (file.exists())
		    {
		        ...
		        {
		        	File directory = new File(Environment.getExternalStorageDirectory(), "meerkatimage.jpg");
		        	File directory2 = new File(Environment.getExternalStorageDirectory(), "oldmeerkatimage.jpg");
		        	if(directory.exists()){
		        		if (directory2.exists()) {
		        			directory2.delete();
		        			File blah = new File(Environment.getExternalStorageDirectory(), "oldmeerkatimage.jpg");
	    	    ...
	    	    File file2 = new File (thing2, "oldmeerkatimage.jpg");
	    	    if (file2.exists())
	    	    {
	    	    
	      	          String p2 = thing2 + "/oldmeerkatimage.jpg";
		    	    ...
		    	    File file = new File (thing, "meerkatimage.jpg");
		        	  if (file.exists())
		      	    {
		      	            ...
		      	            TextView t = (TextView)findViewById(R.id.textView3);  
		      	            t.setText("Last picture taken on: " + date);
		      	          String p = thing + "/meerkatimage.jpg";
		      	        BitmapFactory.Options opt = new BitmapFactory.Options();
			            opt.inSampleSize = 8;
		            ...
		            switch (currentImage) {
		            case 0:  imageI.setImageResource(R.drawable.meerkat);
		                     break;
		            case 1: if (file.exists())
	            	{ imageI.setImageBitmap(initial); }
		            else { imageI.setImageResource(R.drawable.meerkat);
		            currentImage = 0;
		            }
	 	            break;
		            ...
		            currentImage = 0;
	 	            ...
	 	            break;
		            default: imageI.setImageResource(R.drawable.meerkat);
		            currentImage = 0;
		            }
		            }
	@Override
